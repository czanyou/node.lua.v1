...
meta.homepage    = "https://github.com/luvit/luvit/blob/master/deps/fs.lua"
meta.description = "Node-style filesystem module for luvit"
meta.tags        = { "luvit", "fs", "stream" }
