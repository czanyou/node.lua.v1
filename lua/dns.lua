...
meta.homepage   = "https://github.com/luvit/luvit/blob/master/deps/dns.lua"
meta.description = "Node-style dns module for luvit"
meta.tags       = { "luvit", "dns" }
...
local function _build_request(qname, id, no_recurse, opts)
    ...
    local ident_hi = char(id >> 8)
    local ident_lo = char(id & 0xff)
