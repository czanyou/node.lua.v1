...
--]]
local meta = { }
meta.name        = "luvit/http"
meta.version     = "1.2.3"
meta.license     = "Apache 2"
meta.homepage    = "https://github.com/luvit/luvit/blob/master/deps/http.lua"
meta.description = "Node-style http client and server module for luvit"
meta.tags        = { "luvit", "http", "stream" }
...
local codec = require('ext/http_codec')
...
function exports.ClientRequest.getDefaultUserAgent()
    if exports.ClientRequest._defaultUserAgent == nil then
        exports.ClientRequest._defaultUserAgent = 'luvit/http/' .. exports.meta.version
    end
