...
exports.name        = "luvit/http_codec"
exports.version     = "1.0.0-1"
exports.homepage    = "https://github.com/luvit/luvit/blob/master/deps/http_codec.lua"
...
exports.decoder = function()
    ...
    local mode
    -- state variable that points to various decoders
    local bytesLeft
    -- For counted decoder
